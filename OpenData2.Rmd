...
The following code snippets are focused on trying to expand the use of avaialble data in Paleolithic research. These blocks of code are focused on providing an example of the kind of data available. They also provide the code necessary to immediatley begin working with this data.
