...
##Rezek
###In 2018 Rezeke published a large data set of flakes from various contexts to investigate patterns over the course of 2 million years. 
...
Reti<-fread('https://figshare.com/articles/Reti_PLOS_ONE_Data_xlsx')
